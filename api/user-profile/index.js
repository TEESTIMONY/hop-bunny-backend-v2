...
if (!firebase.apps.length) {
  try {
    ...
    console.log('Firebase initialized successfully in user-profile/index.js');
  } catch (error) {
    console.error('Error initializing Firebase in user-profile/index.js:', error);
  }
}
...
module.exports = async (req, res) => {
  console.log('User profile endpoint called with method:', req.method);
